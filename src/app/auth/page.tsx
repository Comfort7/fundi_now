        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="font-medium">Find Workers</div>
                  <div className="text-xs text-gray-500">I need work done</div>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="text-xs text-gray-500">I'm a worker</div>
                </button>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? (
                <>
                  <span className="animate-spin -ml-1 mr-3 inline-block">⭕</span>
